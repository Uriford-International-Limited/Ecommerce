...
const Account = () => {
  return (
    <div className="flex w-full max-w-[450px] mx-auto lg:py-[106px] flex-col gap-6">
      <Tabs defaultValue="login">
        ...
        <TabsContent value="login">
          <p className="pt-4 lg:pt-8 text-center text-[13px] leading-[150%] tracking-[-0.02em] text-[#030712]">
