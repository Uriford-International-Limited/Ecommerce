...
import { User, Heart, ShoppingCart, Search, MapPin, Menu, X, ChevronDown } from "lucide-react";
      ...
      <div className="container mx-auto px-2 sm:px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-4 lg:space-x-6 text-gray-700">
          ...
          <Link href="/cart" className="relative hover:text-gray-900">
            ...
            <span className="absolute -top-1 -right-2 bg-destructive text-white text-xs rounded-full px-1">3</span>
          </Link>
        </nav>
