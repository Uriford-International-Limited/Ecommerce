...
import { afterHero } from "@/datas/afterHero";
        ...
        {afterHero.map(({ image, label, des }, idx) => (
          ...
          >
            <div className="w-2/3 space-y-1 lg:space-y-2">
              <p className="text-xs lg:text-sm text-destructive">Only This Week</p>
              <h3 className="text-lg lg:text-2xl ls:font-semibold font-bold text-black">{label}</h3>
