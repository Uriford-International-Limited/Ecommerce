...
const BrandCard = ({ brand }: Props) => {
  return (
    <Card className="group overflow-hidden transition hover:-translate-y-1">
      ...
      <CardContent className="p-2 lg:p-4 flex items-center justify-between">
        <div className="flex flex-col">
          <h3 className="pb-1 lg:pb-2 text-sm font-medium text-muted truncate">
            {brand.name}
          </h3>
        ...
        {brand.rating !== undefined && (
          <div className="ml-3 inline-flex items-center text-sm text-chart-3">
